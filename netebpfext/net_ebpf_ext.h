...
typedef struct _net_ebpf_extension_wfp_filter_context
{
    ...
    uint32_t filter_instance_count; ///< Number of WFP filter instances.
...
typedef enum _net_ebpf_extension_hook_id
{
    ...
    EBPF_HOOK_ALE_ENDPOINT_CLOSURE_V4,
    EBPF_HOOK_ALE_ENDPOINT_CLOSURE_V6,
    EBPF_HOOK_ALE_AUTH_CONNECT_V4,
    EBPF_HOOK_ALE_AUTH_CONNECT_V6,
    EBPF_HOOK_ALE_CONNECT_REDIRECT_V4, // 10
    ...
    EBPF_HOOK_ALE_FLOW_ESTABLISHED_V6 // 15
