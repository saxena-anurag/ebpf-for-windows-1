...
#define EBPF_MAP_CLIENT_DATA_CURRENT_VERSION_SIZE EBPF_SIZE_INCLUDING_FIELD(ebpf_map_client_data_t, base_client_table)
...
#define EBPF_BASE_MAP_PROVIDER_PROPERTIES_CURRENT_VERSION_TOTAL_SIZE sizeof(ebpf_base_map_provider_properties_t)
#define EBPF_BASE_MAP_PROVIDER_PROPERTIES_HEADER             \
    {EBPF_BASE_MAP_PROVIDER_PROPERTIES_CURRENT_VERSION,      \
     EBPF_BASE_MAP_PROVIDER_PROPERTIES_CURRENT_VERSION_SIZE, \
...
#define EBPF_BASE_MAP_CLIENT_DISPATCH_TABLE_HEADER             \
    {EBPF_BASE_MAP_CLIENT_DISPATCH_TABLE_CURRENT_VERSION,      \
     EBPF_BASE_MAP_CLIENT_DISPATCH_TABLE_CURRENT_VERSION_SIZE, \
